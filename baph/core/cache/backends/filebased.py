...
from baph.core.files.move import file_move_safe
from baph.utils.encoding import force_bytes
...
class FileBasedCache(BaseCache):
    cache_suffix = '.baphcache'

    def __init__(self, dir, params):
        super(FileBasedCache, self).__init__(params)
        self._dir = os.path.abspath(dir)
        self._createdir()
        self.opener = params.get('opener', params.get('OPENER', io.open))
    ...
    def get(self, key, default=None, version=None):
        ...
        try:
            with self.opener(fname, 'rb') as f:
