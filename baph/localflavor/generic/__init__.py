...
COUNTRIES = (
    ...
    ('UA', _('Ukraine')),
    ('UG', _('Uganda')),
    ('UM', _('United States Minor Outlying Isl.')),
...
This value must be in the LANGUAGES setting in the settings.py module.'''))


def isValidCountry(field_data, all_data):
    if not field_data in [lang[0] for lang in COUNTRIES]:
        raise ValidationError(_('''\
This value must be in the COUNTRIES setting in the localflavor.generic
package.'''))
